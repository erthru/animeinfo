<template>
  <div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="alert alert-success" id="alertStudio" role="alert">Showing result by studio ...</div>
    ...
    loadContent() {
      axios
        ...
        .then(response => {
          ...
          $("#alertStudio").text("Showing result by studio "+response.data.result.data[0].studio.name);
        });
    },
